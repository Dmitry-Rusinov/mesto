...
const elementsCardContent = document.querySelector('.elements__card-content');
...
function createCard({name, link}) {
  const changedElements = elementsCardContent.querySelector('.elements__card').cloneNode(true);
