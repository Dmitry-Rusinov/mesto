...
const cardDescription = popupAddCard.querySelector('#popup__input_card_description');
const picturesLink = popupAddCard.querySelector('#popup__input_pictures-link');
