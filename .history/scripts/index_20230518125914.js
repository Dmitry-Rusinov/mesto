...
const buttonPopupClosed = document.querySelectorAll('.popup__closed');
...
/*const buttonClosed = (evt) => {
  const item = evt.target.closest('.popup__closed');
  item.classList.toggle('popup_opened');
}
function popupClosed() {
document.querySelector('.popup__closed').addEventListener('click', buttonClosed);
}
popupClosed()

buttonPopupClosed.forEach((button) => {
...
templateCard.querySelector('.elements__button-delete').addEventListener('click', deleteCard);
templateCard.querySelector('.elements__button-like').addEventListener('click', buttonLike);
