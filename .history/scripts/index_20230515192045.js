...
const toggleButtonLike = (buttonLikeToToggle) => buttonLikeToToggle.classList.toggle('elements__button-like_active');
...
function createCard({name, link}) {
  ...
  changedElements.querySelector('.elements__button-like').addEventListener('submit', toggleButtonLike);
