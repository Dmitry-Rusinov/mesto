...
function createCard({name, link}) {
  ...
  const changedElements = elementsCard.querySelectorAll('.elements__card-content');
  changedElements.querySelectorAll('.elements__title').textContent = name;
  changedElements.querySelectorAll('.elements__picture').src = link;
