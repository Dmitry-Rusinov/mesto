...
const deleteCard = (evt) => {
  ...
  changedElements.querySelector('.elements__button-like').addEventListener('click', function(){
    this.classList.toggle('.elements__button-like_active');
});
...
function addCardSubmit (evt) {
  evt.preventDefault();  
  const item = cardDescription.value;
  const links = picturesLink.value;
