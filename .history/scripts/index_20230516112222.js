...
//Реализация модального окна изоображений
 const imageToPopup = elementsCard.querySelector('.elements__picture');
 const popupImage = document.getElementsByClassName('.popupImage');
 const popupImageButtonClosed = popupImage.querySelector('.popup__closed');
 const imageTitle = document.querySelector('.popup__image-title');

elementsCard.querySelector('.elements__picture').addEventListener('click', () => {
