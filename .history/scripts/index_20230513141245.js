...
let togglePopupState = (popupEditFormToToggle) => popupEditFormToToggle.classList.toggle('popup_opened');
...
let togglePopupStates = (popupAddCardToToggle) => popupAddCardToToggle.classList.toggle('popup_opened');