...
function createCard({name, link}) {
  ...
  /*changedElements.querySelector('.elements__title')*/elementsTitle.textContent = name;
  /*changedElements.querySelector('.elements__picture')*/elementsPicture.src = link;
  /*changedElements.querySelector('.elements__picture')*/elementsPicture.alt = name;
