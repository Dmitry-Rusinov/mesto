...
//const toggleButtonLike = (buttonLikeToToggle) => buttonlikeToToggle.classList.toggle('popup_opened');
...
function createCard({name, link}) {
  ...
  changedElements.querySelector('.elements__button-like').addEventListener('click', () => {
    const item = changedElements.querySelector('elements__button-like_active').classList.toggle;
    return item
  });
...
const newCardDescription = document.querySelector('.elements__title');
const newPicturesLink = document.querySelector('.elements__picture');
