...
const popupImageContent = document.querySelectorAll('.elements__card-content img');
...
const nameOfPicture = document.querySelectorAll('.elements__title');
let imgSrc;
...
let imgModal = (src) => {
 ...
 /* for (let i = 0; i < nameOfPicture.length; ++i) {
    let picture = nameOfPicture[i];
    newImageTitle.innerHTML = picture.textContent;
  }*/

 /* nameOfPicture.forEach((it) => {
    let item = nameOfPicture[it];
    newImageTitle.innerHTML = item.textContent;
  });*/
  for (let i = 2; i < nameOfPicture.length; ++i) {
    const newImageTitle = modal.querySelector('.popup__image-title');
    let picture = nameOfPicture[i];
    newImageTitle.innerHTML = picture.textContent;
}
